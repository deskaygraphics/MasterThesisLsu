...
% Configure DOI to display on separate line with full URL
...
While natural mechanisms such as sediment consolidation, glacial isostatic adjustment, and tectonic motion contribute to subsidence,
 ...
 high-impact events worldwide (\citeauthor{Galloway2014}, \citeyear{Galloway2014};
...
in the southern United States \citep{Galloway2000SubsidenceUS}.
...
\citep{Galloway2000SubsidenceUS}.
...
\citep{Crosetto2016,Galloway2014}.
...
in interferograms \citep{Ferretti2007InSAR}.
...
widely adopted for atmospheric phase screen correction in InSAR studies \citep{Hersbach2020ERA5}.
...
InSAR-derived deformation was validated using GNSS vertical displacement time series
 ...
 standard benchmark for InSAR timeseries validation \citep{Hanssen2001InSAR,blew}
...
withdrawal \citep{Galloway2014}. In rapidly urbanizing regions like the Lower Mississippi Basin, the interplay between shallow geology and heavy infrastructure 
...
and structural failures, resulting in significant economic losses \citep{Wang2021}.
...
\nocite{Galloway2000SubsidenceUS}
