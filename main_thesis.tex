...
InSAR enables precise measurement of surface displacement over large spatial extents \citep{Massonnet1998}.
...
proved effective for mapping rapid and spatially coherent deformation associated with earthquakes and volcanic activity \citep{Massonnet1993}. However, its 
...
particularly over vegetated or urbanizing surfaces \citep{Hanssen2001InSAR}.
...
such as buildings and exposed infrastructure (Ferretti2001). By analysing large stacks of SAR acquisitions, PS-InSAR achieves sub-millimeter precision on built infrastructure \citep{Ferretti2001,Ferretti2011a}. However, PS-InSAR is often sparse in non-urbanized or vegetated areas, limiting its applicability to mixed land-cover environments.
...
InSAR techniques, arising from changes in surface scattering properties caused by vegetation growth, soil moisture variation, and anthropogenic activity \citep{Zebker1992}.
