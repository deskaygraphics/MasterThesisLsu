...
The SBAS-InSAR processing of 246 Sentinel-1 acquisitions (2017--2025) produced a spatially continuous velocity field at 30~m resolution covering the entire study area (Figure~\ref{fig:velocity_map}). The mean vertical displacement velocity across East Baton Rouge Parish was $-2.47$~mm/yr, with a standard deviation of $\pm 1.83$~mm/yr. Maximum subsidence rates of $-12.3$~mm/yr were observed in the southern urban corridor near the Baton Rouge fault zone, while minor uplift of $+2.1$~mm/yr occurred in elevated forested areas in the northern portion of the parish.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.49\textwidth]{media/sbas_vel.png}
\includegraphics[width=0.49\textwidth]{media/sbas_susc.png}
...
\hline
Extra Trees    & 0.9236 & 1.10 & 0.72 & 45 \\
Random Forest  & 0.8278 & 1.65 & 1.16 & 120 \\
\hline
\end{tabular}
\end{table}

The optimized models were applied to generate spatially continuous maps at 30~m resolution. Predicted velocities range from $-11.2$ to $+1.8$~mm/yr. Susceptibility classification identified: high-risk zones ($>5$~mm/yr subsidence) covering 89~km$^2$ (18.9\% of parish area), moderate-risk (2--5~mm/yr) covering 156~km$^2$ (33.1\%), and low-risk ($<2$~mm/yr) covering 226~km$^2$ (48.0\%).

\begin{figure}[!t]
\centering
\includegraphics[width=0.49\textwidth]{media/et_vel.png}
\includegraphics[width=0.49\textwidth]{media/et_susc.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.49\textwidth]{media/rf_vel.png}
\includegraphics[width=0.49\textwidth]{media/rf_susc.png}
...
\label{fig:susceptibility_map_rf}
\end{figure}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.49\textwidth]{media/shap_sum_et.png}
\includegraphics[width=0.49\textwidth]{media/shap_sum_rf.png}
\caption{SHAP summary plots for ET (left) and RF (right). Red = high feature value, blue = low.}
\label{fig:shap_summary}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=0.49\textwidth]{media/shap_bar_et.png}
\includegraphics[width=0.49\textwidth]{media/shap_bar_rf.png}
\caption{SHAP bar plots showing mean absolute SHAP values for ET (left) and RF (right).}
\label{fig:shap_bar}
\end{figure}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.49\textwidth]{media/lime_et.png}
\includegraphics[width=0.49\textwidth]{media/lime_rf.png}
\caption{LIME local explanations for representative high-subsidence locations. Orange bars indicate positive contributions to subsidence; blue bars indicate negative contributions.}
...
Autoregressive forecasting to 2030 (Figure~\ref{fig:forecast_maps}) indicates progressive stabilization, with mean velocity declining from the historical baseline of $-2.47$~mm/yr to $-0.530$~mm/yr by 2030---a 78.5\% reduction. This deceleration aligns with physical expectations of aquifer-system compaction approaching steady state as pore-pressure equilibration progresses \citep{Higgins2016}. Cumulative displacement from 2025 to 2030 reaches $-6.42$~mm in persistent high-subsidence zones, with spatial variability ranging from $-1.2$ to $-12.8$~mm.

\begin{figure}[!t]
\centering
\includegraphics[width=0.49\textwidth]{media/lstm_vel.png}
\includegraphics[width=0.49\textwidth]{media/lstm_susc.png}
...
\begin{itemize}
\item \textbf{InSAR}: Reduced coherence in vegetated areas; residual atmospheric artifacts; LOS projection assumes vertical motion.
\item \textbf{ML Models}: Assumes temporal stationarity; limited to 15 conditioning factors; spatial extrapolation untested.
\item \textbf{Forecasting}: 5-year extrapolation beyond observations; assumes constant extraction patterns; limited 2-year validation period.
\item \textbf{Validation}: Only two GNSS stations available; no independent levelling data.
\end{itemize}

Future work should expand GNSS coverage, integrate multi-satellite InSAR, incorporate detailed hydrogeological data, and implement coupled groundwater-subsidence modeling.
