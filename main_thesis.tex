...
Both Random Forest and Extra Trees were implemented to identify the optimal ensemble approach for subsidence susceptibility mapping. While RF has been widely applied in geohazard studies, recent research suggests that Extra Trees may achieve superior generalization in complex, multi-factorial systems \citep{Geurts2006}.
